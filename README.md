...
# Application Web de Gestion et de Génération de Cartes d'Identité Scolaires ( Framework LARAVEL de PHP)
...
### 2. Clonage du dépôt
```bash
git clone https://github.com/Diby-dev/LE_PROJET_REVSCHOOL.git
